...
<div class="row collapse multi-collapse show m-0 mb-3" id="multiCollapse_week4">
	<div class="col-12 m-0">
...
$(document).ready(function(){
	...
	$( document ).ajaxComplete(function() {
		...
		function AjaxCallDagenOverzicht() {
			...
			$.ajax ({
				url : "<?php echo site_url("Orders/afdelingen_werklijst_pe/" . $_POST['week_nr']) ?>",
				type : 'GET',
